...
On the left is a population of 1 million simulated over about 5 years with a masking rate of 80% at random in the population. The right is the same simulation but with a masking rate of only 60%. ([Full video](https://vimeo.com/514490979)) The contagion itself is modeled after SARS-COV-2. Low masking rates lead to potential endemics.
